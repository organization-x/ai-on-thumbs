  ...
  return (
    <LinearGradient colors={['#8976C2', '#E6E8FB']} style={styles.container}>
      <View style={styles.interactive}>
        ...
        <Text style={styles.text}>Once the computer detects one feature it is easier to find more until a face is detected.</Text>
      </View>
      <View style={styles.footerButtons}>
        <LessonButton navigation={navigation} nextScreen='Course2AlgorithmReview3' buttonColor='#8976C2' buttonText='Back' />
