...
// import * as Analytics from 'expo-firebase-// analytics'Analytics.setCurrentScreen('Course 2 Screen 13: Filter Features 5 Screen')
  ...
  return (
    <View style={styles.container}>
      <View style={styles.top}>
        ...
        <Text style={styles.pagenumber}>11/26</Text>
      </View>
