...
// import * as Analytics from 'expo-firebase-// analytics'Analytics.setCurrentScreen('Course 2 Screen 12: Filter Features 4 Screen')
  ...
  return (
    <View style={styles.container}>
      <View style={styles.top}>
        ...
        <Text style={styles.pagenumber}>10/26</Text>
      </View>
