  ...
  return (
    <LinearGradient colors={['#8976C2', '#E6E8FB']} style={styles.container}>
      ...
      <View style={styles.footerButtons}>
        <LessonButton navigation={navigation} nextScreen='' buttonColor='#8976C2' buttonText='Back' />
        <LessonButton navigation={navigation} nextScreen='' buttonColor={['#32B59D', '#3AC55B']} buttonText='Continue' />
      </View>
