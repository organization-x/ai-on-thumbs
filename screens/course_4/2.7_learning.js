  ...
  return (
    <LinearGradient colors={['#8976C2', '#a3acff']} style={styles.container}>
      <View style={styles.interactive}>
        ...
        <Text style={styles.text}>To begin, a NN randomly assigns a number for each node and takes an input</Text>
        <Text style={styles.text}>Then, the model compares its output to the desired answer</Text>
      </View>
