  ...
  return (
    <LinearGradient colors={['#8976C2', '#a3acff']} style={styles.container}>
      <View style={styles.interactive}>
        ...
        <Text style={styles.text}>As shown in this image</Text>
      </View>
      {/* <View>
        <Image style={styles.image} source={require('../../assets/course_4/nn layers.gif')} />
      </View> */}
      <View style={styles.interactive}>
        <Text style={styles.boldText}></Text>
        <Text style={styles.text}>NNs have 3 general types of layers: Input, Hidden and Output Layers</Text>
      </View>
