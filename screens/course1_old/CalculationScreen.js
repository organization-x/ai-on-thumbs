  ...
  return (
    <LinearGradient colors={['#8976C2', '#FFFFFF']} style={styles.container}>
      ...
      <View style={styles.footerButtons}>
        <LessonButton navigation={navigation} nextScreen='CalcContrastScreen' buttonColor='#8976C2' buttonText='Back' />
        <LessonButton navigation={navigation} nextScreen='RedComplexityScreen1' buttonColor={['#32B59D', '#3AC55B']} buttonText='Continue' />
      </View>
    </LinearGradient>
  )
}
